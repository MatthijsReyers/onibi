...
//         sanitize.setBoolRules({ undefinedValues: 'error' })
//         expect(() => {
//             sanitize.bool(undefined);
//         }).to.throw(UndefinedValueError, 'missing');

//         sanitize.setBoolRules({ undefinedValues: true })
//         result = sanitize.bool(undefined);
//         expect(result).to.be.true;

//         sanitize.setBoolRules({ undefinedValues: false })
//         result = sanitize.bool(undefined);
//         expect(result).to.be.false;

//         sanitize.setBoolRules({ undefinedValues: 'default', default: true })
//         result = sanitize.bool(undefined);
//         expect(result).to.be.true;

//         sanitize.setBoolRules({ default: false })
//         result = sanitize.bool(undefined);
//         expect(result).to.be.false;
//     });
...
//         sanitize.setBoolRules({ nullValues: 'error' })
//         expect(() => {
//             sanitize.bool(null);
//         }).to.throw(NullValueError, 'cannot be null');

//         sanitize.setBoolRules({ nullValues: true })
//         result = sanitize.bool(null);
//         expect(result).to.be.true;

//         sanitize.setBoolRules({ nullValues: false })
//         result = sanitize.bool(null);
//         expect(result).to.be.false;

//         sanitize.setBoolRules({ nullValues: 'default', default: true })
//         result = sanitize.bool(null);
//         expect(result).to.be.true;
